...
Image.MAX_IMAGE_PIXELS=138283200
...
__all__ = [
    ...
    "transform_unsupervised_annotations",
...
def transform_unsupervised_annotations(
    bbox, transforms, image_size, *, keypoint_hflip_indices=None
):
    """
    Apply transforms to box, segmentation and keypoints annotations of a single instance.
