...
def bs64_lvis_scheduler(epochs=50, decay_epochs=40, warmup_epochs=0):
    """
    ...
    """
    # total number of iterations assuming 16 batch size, using 1440000/16=90000
    total_steps_16bs = epochs * 1775
    decay_steps = decay_epochs * 1775
    warmup_steps = warmup_epochs * 1775
    scheduler = L(MultiStepParamScheduler)(
        values=[1.0, 0.1],
...
def default_coco_scheduler(epochs=50, decay_epochs=40, warmup_epochs=0):
    ...
    """
    # total number of iterations assuming 16 batch size, using 1440000/16=90000
    total_steps_16bs = epochs * 7100
    decay_steps = decay_epochs * 7100
    warmup_steps = warmup_epochs * 7100
    scheduler = L(MultiStepParamScheduler)(
        values=[1.0, 0.1],
        milestones=[decay_steps, total_steps_16bs],
    )
...
lr_multiplier_12ep_64bs = bs64_lvis_scheduler(12, 11, 0)
